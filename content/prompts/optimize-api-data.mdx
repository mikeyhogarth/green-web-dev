---
title: Optimize API data access patterns
category: backend
difficulty: medium
status: draft
---

Minimize the amount of data returned by a single API request. There are many ways you can do this, such as:
...
## The classic example: Blog with comments

Consider a blog with comments - a poor API might expose an endpoint like this as being the only way to get a list of the blogs for a given month;

```
GET /blogs/?year=2021&month=10
[
  {
    "id": 1,
...
```
GET /blogs/?year=2021&month=10&fields=title,date,commentCount&skip=0&take=10
[
  {
    "title": "My first article",
    "date": "2021-10-10",
