...
Choose a browser support strategy that is sustainable. At the most basic level, this should include a commitment to support the most modern versions of each browser and a "cut off" point for when you stop supporting older versions of a particular browser - where that cut-off point lies is up to you, but the main crux of this prompt is simply to "have a strategy".
