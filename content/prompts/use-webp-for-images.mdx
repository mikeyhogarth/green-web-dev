...
> ### AVIF
>
> A successor to webP format already exists in the form of **AVIF** which promises even better compression, however [AVIF browser support](https://caniuse.com/avif) is not yet mature enough to use it without a fallback image (see Compatibility below).
