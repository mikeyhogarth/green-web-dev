...
Consider a form label, which will default to being an `inline` element. This means that when rendered, the label will appear to the left of any preceding input element;
